                ...
                <div className="row">
                    <div className="sixteen wide column">
                        <form className="ui form sf" style={{ width: '80%' }}>
                            <div className="field" style={{ position: 'absolute', display: 'flex', justifyContent: 'center', alignItems: 'center', height: 'auto', width: '100%' }}>
                                <input placeholder="Enter your user id" style={{ flex: '20' }} onChange={e => { this.setState({ username: e.target.value }) }} type="text" name="username" value={this.state.username} />
                                ...
                                <Link to={{
                                    pathname: `/profile/${this.state.selectedPlatform}/${this.state.username}`, state: { selectedPlatform: this.state.selectedPlatform }
                                }} className="ui animated button" style={{ flex: '2', width: '10vh' }} tabIndex="0">
                                    <div className="visible content">Next</div>
                                    <div className="hidden content">
                                        <i className="right arrow icon"></i>
                                    </div>
